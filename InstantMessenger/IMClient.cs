...
namespace InstantMessenger
{
    public class IMClient
    {
        ...
        string _mobileno;      //MobileNo
        bool reg;              // Register mode

        //public string Server { get { return "localhost"; } }  // Address of server. In this case - local IP address.
        //public int Port { get { return 2000; } }

        public string Server { get { return "197.242.148.230"; } }  // Address of server. In this case - local IP address.
        public int Port { get { return 2000; } }
        ...
        public string MobileNo { get { return _mobileno; } }
        ...
        void connect(string user, string password,string emailaddress,string mobileno, bool register)
        {
            if (!_conn)
            {
                _conn = true;
        ...
        public void Login(string user, string password, string emailaddress, string mobileno)
        {
            connect(user, password, emailaddress, mobileno, false);
        }
        ...
        public void Register(string user, string password,string emailaddress,string mobileno)
        {
            connect(user, password,emailaddress,mobileno, true);
        }
