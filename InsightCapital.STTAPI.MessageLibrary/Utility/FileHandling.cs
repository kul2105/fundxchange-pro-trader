...
namespace InsightCapital.STTAPI.MessageLibrary.Utility
{
    ...
    //                _struct.Add(dm.CreateParam("Price", OleDbType.Decimal, order));
    ...
    //                _struct.Add(dm.CreateParam("Price", OleDbType.Decimal, trade));
    ...
    //                _struct.Add(dm.CreateParam("Price", OleDbType.Decimal, report));
